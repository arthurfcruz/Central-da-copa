...
const apiEndPoint =
  "https://apigenerator.dronahq.com/api/U6xEuHqk/dataJogadores";
...
function mudarPosicao() {
  switch (iPosicao) {
    case 0:
      posicao?.innerHTML = "Meio Campo";
      iPosicao++;
      break;
    case 1:
      posicao?.innerHTML = "Defensores";
      iPosicao++;
      break;
    case 2:
      posicao?.innerHTML = "Goleiros";
      iPosicao++;
      break;
    case 3:
      posicao?.innerHTML = "Atacantes";
      iPosicao = 0;
      break;
  }
}
...
function addDisplay(jogadores) {
  ...
  for (let i = 0; i < jogadores.length; i++) {
    ...
    `;
      ...
      divCarousel?.appendChild(newCard);
    }
  }
...
function removerCards() {
  ...
  divCarousel_Wrapper?.appendChild(newCarousel);
}

function verificaPosicao() {
  switch (posicao?.textContent) {
    case "Atacantes":
